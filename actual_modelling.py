...
def train_model(inputDf, target, nrounds, lr, startingModel, weights=None, staticFeats = [], pen=0, specificPenas={}, lossgrad=calculus.Poisson_grad, link=calculus.Unity_link, linkgrad=calculus.Unity_link_grad, prints="verbose"):
